 ...
 */
package ru.tinkoff.edu.java.scrapper.model.jooq.tables;
...
import ru.tinkoff.edu.java.scrapper.model.jooq.Keys;
import ru.tinkoff.edu.java.scrapper.model.jooq.Public;
...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field("now()", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>public.link.update_data</code>.
     */
    public final TableField<LinkRecord, JSONB> UPDATE_DATA = createField(DSL.name("update_data"), SQLDataType.JSONB.nullable(false).defaultValue(DSL.field("'{}'::jsonb", SQLDataType.JSONB)), this, "");
